...
from sarc.notifications.usage import get_all_users_usage as _real_get_all_users_usage
from sarc.notifications.usage import (
    get_recurring_underusers as _real_get_recurring_underusers,
)
from sarc.notifications.usage import get_underusers as _real_get_underusers
...
def test_min_waste_ratio_flag_overrides_config(
    ...
    monkeypatch.setattr("sarc.cli.notify.usage.get_underusers", spy)
...
def test_usage_report_min_usage_rgu_hours_flag_overrides_config(
    ...
    monkeypatch.setattr("sarc.cli.notify.usage.get_all_users_usage", spy)
